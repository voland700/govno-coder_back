			...
			<div class="navbar">
				<div class="logo_wrap">
					...
					<nav class="menu" id="menu">
						<ul class="menu_list">
							<li class="menu_item">
								<a href="#" class="menu_link">Новости</a>
							</li>
							<li class="menu_item __active">
								<a href="#" class="menu_link many">Статьи</a>

								<ul class="submenu_list">
									<li class="submenu_item">
										<a href="#" class="submenu_link">Печи</a>
									</li>
									<li class="submenu_item">
										<a href="#" class="submenu_link">Камины</a>
									</li>
									<li class="submenu_item">
										<a href="#" class="submenu_link">Дымоходы</a>
									</li>
									<li class="submenu_item">
										<a href="#" class="submenu_link">Печи</a>
									</li>
									<li class="submenu_item">
										<a href="#" class="submenu_link">Литё</a>
									</li>
									<li class="submenu_item">
										<a href="#" class="submenu_link">Печные смеси</a>
									</li>
									<li class="submenu_item">
										<a href="#" class="submenu_link">Грили и мангалы</a>
									</li>
								</ul>
							</li>
							<li class="menu_item">
								<a href="#" class="menu_link">Теги</a>
							</li>
						</ul>
					</nav>
